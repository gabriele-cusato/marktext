...
// R1: reduced from 500. Unified history (H8) is the primary Ctrl+Z for md files; native
// Muya history is kept for fallback dirty-check/remount consistency but no longer needs 500 deep-copies.
